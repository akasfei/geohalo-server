...
function checkJsonFormatAndField(data, fieldArray, callback){
  ...
  fieldArray.forEach(function(field){
    if(!obj.hasOwnProperty(fieldArray[field]) || obj[field] === null){
      logger.error("checkJsonFormatAndField", "packet type", type, "json ", body);
      return callback(new Error('checkJsonFormatAndField require field ' + field), null);
    }
  });
